document.addEventListener("DOMContentLoaded", function () {
    ...
    const addToCartButton = document.querySelector(".btn-custom"); // Select existing "Add to Cart" button
    const cartItemsContainer = document.getElementById("cart-items");
    const cartTotal = document.getElementById("cart-total");

    // Fetch and display products on the Shop page
    if (productList) {
    ...
    // Fetch and display product details on the Details page
